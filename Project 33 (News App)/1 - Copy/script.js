...
const  sumbitBtn = document.querySelector(".newsSubmit")
const newsInput = document.querySelector(".newsSearch")
const navbar = document.querySelector(".nav-searchBar");

sumbitBtn.addEventListener("click",()=>{
    navbar.classList.toggle("toggle")
})
sumbitBtn.addEventListener("click",()=>{
    let Input =  newsInput.value;
    if(!Input)return
    fetchNews(Input);
    Input='';
    curSelectedNav?.classList.remove("active")
